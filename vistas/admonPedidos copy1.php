      ...
      <div style="display:flex">
        <div id="exTab1" style="width: 77%;" class="container">
          ...
          <div class="tab-content clearfix">
            ...
            ?>
              <div class="tab-pane" id="<?php echo $datos2->idcategoriap; ?>">
                ...
                var_dump($datos2->idcategoriap); */
                  ?>
                      <div class="card" precio="<?php echo $datos->precio;  ?>" nombre="<?php echo $datos->nombre;  ?>" producto="<?php echo $datos->nombre;  ?>" producto_id="<?php echo $datos->idproducto;  ?>" style="flex-grow: 1;width: 33%; margin:20px">
                        <img class="card-img-top" src="../../LA-MULATA/imagenes/pizza.jpg" alt="Card image cap">
                        <div class="card-body">
            ...
            <div class="tab-pane active" id="333">
              <img src="../../LA-MULATA//imagenes/Logo-sin.png" style="width: 100%;height: 100%; object-fit: contain;" alt="">
            </div>
        ...
        <div class="cuenta" style="width: 27%;">
          ...
          <ul class="list-group" style="width: 100%;">
            ...
            <div style="display:flex;">
              <p>Valor:</p>
              <p>$</p> <p class="precio"> 0</p>
            </div> 
            <div>
            <h3>Seleccionar mesa</h3>
            </div>
            <div style="width:50% ; margin-bottom:10px">
            <select style="width: 100%;" class="form-select form-select-sm" aria-label=".form-select-sm example">
    ...
    $(".card").click(function() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          $(".list-group").prepend("<li class='list-group-item'precio=" + precio + " producto_id=" + producto_id + ">" + producto + "</li>");
          array.push({id_p:producto_id ,precio: precio, nombre:nombre});
          console.log(array);
          Swal.fire(
            'Agregado',
     ...
     if(valor_total==0){
      ...
      Swal.fire({
        ...
        success: function(response) { //una vez que el archivo recibe el request lo procesa y lo devuelve
          ...
          CargarContenido('vistas/admonPedidos.php','content-wrapper')
        }
      });
