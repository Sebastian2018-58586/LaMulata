        ...
        <tbody>
          ...
          ?>
              ...
              <tr>
                ...
                <td><button type="button" class="btn btn-primary ver_pedido" id_pedido="e<?php echo $datos2->id_pedido  ?>">Facturar</button></td>
              </tr>
          <?php
            }
          }
...
?>
  <div class="e<?php echo $datos->id_pedido ?> content2">
    ...
    <div class="input-group mb-3">
      <input type="text" id="identificacion<?php echo $key ?>" class="form-control" placeholder="Ingrese la cedula del cliente" aria-label="Recipient's username" aria-describedby="basic-addon2">
      
    </div>
    <div class="input-group mb-3">
      <input type="text" id="nombre<?php echo $key ?>" class="form-control" placeholder="Ingrese el nombre del cliente" aria-label="Recipient's username" aria-describedby="basic-addon2">
    ...
    <button type="button" detalle="<?php echo $datos->id_pedido ?>" nombre="nombre<?php echo $key ?>"  identificacion="identificacion<?php echo $key ?>"   class="btn btn-primary despachar">Facturar Pedido</button>
  </div>
    ...
    $(".despachar").click(function() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          console.log();
         window.location.href = "ajax/facturacion-ajax.php/?id=" + detalle_id + "&nombre=" + nombre_value + "&identificacion=" + identificacion_value;
