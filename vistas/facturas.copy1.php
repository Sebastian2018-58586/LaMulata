...
<script src="../../LA-MULATA/vistas/modulos/chart.js"></script>
...
?>
  <div class="e<?php echo $datos->id_pedido ?> content2">
    ...
    <button type="button" detalle="<?php echo $datos->id_pedido ?>" nombre="<?php echo $datos->cliente ?>" identificacion="<?php echo $datos->identificacion_cliente ?>" class="btn btn-primary despachar">Ver factura</button>
  </div>
    ...
    $(".despachar").click(function() {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          window.location.href = "ajax/facturacion-ajax2.php/?id=" + detalle_id + "&nombre=" + nombre_value + "&identificacion=" + identificacion_value;
          setTimeout(function() {
