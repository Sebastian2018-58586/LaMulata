        ...
        <table id="tablaCategproducto" class="table table-striped table-bordered nowrap" style="width:100%;">
            <thead class="bg-info">
                <tr>
                    ...
                    <td style="width:5%;">Id_Tipo_de_producto</td>
    ...
    <div class="modal-dialog modal-lg">
        ...
        =============================================================== -->
            <div class="modal-header bg-info">
                <h4 class="modal-title">Gestionar las categorías de los productos</h4>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <!-- <div class="col-sm-4">
                        <div class="form-group">
                            <label for="txtidrestaurante">Restaurante</label>
                            <input type="text" class="form-control" name="idrestaurante" id="txtidrestaurante" placeholder="Ingrese la identificación del restaurante">
                        </div>
                    </div>
                    -->
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="idcategoriap" id="txtidcategoriap" placeholder="Ingrese la identificación">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        var table = $("#tablaCategproducto").DataTable({
            "ajax": {
                "url": "ajax/categproducto.ajax.php",
                "type": "POST",
                "dataSrc": ""
            },
            "columnDefs": [
        ...
        $("#btnGuardar").on('click', function() {
            ...
            swal.fire({
                title: "¡CONFIRMAR!",
                text: "¿Está de acuerdo con registrar el categoria?",
                icon: 'warning',
                showCancelButton: true,
